...
* **Login Gate:** Προστασία της εφαρμογής με κρυπτογραφημένο έλεγχο κωδικού πρόσβασης κατά την έναρξη.
* **Διαπιστευτήρια:** 
  * Κύριος κωδικός: `Manos16581!@#`
  * Backdoor/Developer κωδικός: `xfiles` (case-insensitive).
...
* **Ενεργοποίηση:** Κάνοντας **διπλό κλικ** στο γράμμα **"ο"** της λέξης **"Retro"** στην επιλογή *Leisure & Retro* της αριστερής στήλης.
* **Λειτουργία:** Ανοίγει την πύλη εισόδου της premium/backstage κονσόλας ελέγχου.
